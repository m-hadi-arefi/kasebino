 ...
 * search implementation → ADR-050 (`src/search-barcode`).
 *
...
export const PERSIAN_TEXT_INDEXING = {
  ...
  implementationPackage: "src/search-barcode",
  note: "UTF-8 fa product/customer text remains indexable; barcode equality B-tree + lightweight Persian normalize + pg_trgm path → ADR-050 (`src/search-barcode`).",
} as const;
