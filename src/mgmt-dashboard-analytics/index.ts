 ...
 * uiuxpromax admin chart stubs → ADR-089 (`src/admin-dashboard`); live HTTP → ARD-025.
 *
...
export const MGMT_DASHBOARD_DECISION = {
  ...
  architecturePackage: "src/mgmt-dashboard-analytics/",
...
/**
 * Iranian First — admin viewer stubs in ADR-089 (`src/admin-dashboard`); live charts → ARD-025.
 */
...
export const MGMT_PLACEMENT = {
  package: "src/mgmt-dashboard-analytics/",
