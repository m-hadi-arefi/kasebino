 ...
 * EMQX publish → `src/infrastructure/emqx/contracts` (ADR-038); Mongo warehouse →
 * `src/events/contracts/event-warehouse` (ADR-057); Redis invalidation →
 * `src/infrastructure/redis/cache-invalidation` (ADR-054); Notifications →
...
} from "../contracts/event-driven/index.js";
...
export const OUTBOX_WORKER_DECISION = {
  ...
  emqxPublishPackage: "src/infrastructure/emqx/contracts/",
  ...
  notificationsArchitecturePackage: "src/modules/notifications/domain/contracts/",
