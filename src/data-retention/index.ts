...
export const DATA_RETENTION_DECISION = {
  ...
  architecturePackage: "src/data-retention/",
  architectureDoc: "docs/architecture/data-retention-architecture.md",
  mongodbPlanePackage: "src/mongodb-analytics/",
  dataIntegrityPackage: "src/data-integrity/",
  relatedPackages: {
    clickstream: "src/clickstream/",
    sessions: "src/session-analytics/",
...
export const MONGO_TTL_TABLE = {
  ...
  sessions: {
    ...
    defaultDays: 90,
    expireAfterSecondsDefault: 90 * SECONDS_PER_DAY,
    packageStance: "src/session-analytics/",
    stanceAdr: "ADR-061",
  },
  audit: {
    ...
    packageStance: "src/audit-logging/",
    stanceAdr: "ADR-058",
    subclassHints: {
      securityHotDays: 365,
      adminDays: 730,
  ...
  warehouse: {
    ...
    defaultMonths: 24,
    expireAfterSecondsDefault: 24 * DAYS_PER_MONTH * SECONDS_PER_DAY,
    packageStance: "src/event-warehouse/",
    stanceAdr: "ADR-057",
  },
} as const;
