 ...
 * Mongo plane detail → ADR-056; warehouse → ADR-057 (`src/events/contracts/event-warehouse`);
 * merchant widgets → ADR-063 (`src/modules/analytics/domain/merchant-oltp` + `src/modules/analytics`);
 * management dashboards → ADR-062 (`src/modules/admin/ui/analytics`).
 */

import { ANALYTICS_CRITICAL_PATH, OUTBOX_CONSUMERS } from "../../../../events/contracts/event-driven/index.js";
import { DATA_PLANES, LOCALE_DEFAULTS, PRODUCT_ARCHITECTURE } from "../../../../shared/architecture/product/index.js";
import { COMPOSE_DATA_PLANES } from "../../../../shared/contracts/docker-compose-parity/index.js";
import { getContextById } from "../../../../shared/contracts/bounded-contexts/index.js";
...
export const ANALYTICS_BOUNDARIES_DECISION = {
  ...
  architecturePackage: "src/infrastructure/mongodb/contracts/boundaries/",
  analyticsArchitectureDoc: "docs/architecture/analytics-architecture.md",
  /** ADR-056 — `src/infrastructure/mongodb/contracts/analytics` + thin `src/infrastructure/mongodb` stub. */
  mongoPlaneImplementedIn: "src/infrastructure/mongodb/contracts/analytics/",
  mongoPlaneAdr: "ADR-056",
  warehouseImplementedIn: "src/events/contracts/event-warehouse/",
  warehouseAdr: "ADR-057",
  productAnalyticsImplementedIn: "src/modules/analytics/domain/product/",
  productAnalyticsAdr: "ADR-059",
  clickstreamImplementedIn: "src/infrastructure/mongodb/clickstream/",
  clickstreamAdr: "ADR-060",
  sessionAnalyticsImplementedIn: "src/modules/analytics/domain/session/",
  sessionAnalyticsAdr: "ADR-061",
  /** ADR-063 — projections + counter ports; HTTP/UI remain ARD-016 / ADR-088. */
  merchantOltpWidgetsImplementedIn: "src/modules/analytics/domain/merchant-oltp/",
  ...
  mgmtDashboardImplementedIn: "src/modules/admin/ui/analytics/",
...
export const MERCHANT_OLTP_ANALYTICS = {
  ...
  ard: "ARD-016",
  detailAdr: "ADR-063",
  architecturePackage: "src/modules/analytics/domain/merchant-oltp/",
...
export const ANALYTICS_BOUNDARIES_PLACEMENT = {
  package: "src/infrastructure/mongodb/contracts/boundaries/",
  oltpContextId: "analytics_oltp" as const,
  platformContextId: "analytics_platform" as const,
  detailAdr: "ADR-014",
  mongoPlaneAdr: "ADR-056",
  mongoPlanePackage: "src/infrastructure/mongodb/contracts/analytics/",
} as const;
