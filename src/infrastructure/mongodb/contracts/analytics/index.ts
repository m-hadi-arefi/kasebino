 ...
 * `src/events/contracts/event-warehouse/` (ADR-057). Failure isolation from checkout → ADR-065
 * (`src/infrastructure/mongodb/contracts/ingest-isolation/`). Official Mongo protocol driver optional
 ...
 * Buffer/retry/drop + metrics → ADR-065 (`src/infrastructure/mongodb/contracts/ingest-isolation/`).
 */
export const FAILURE_ISOLATION = {
  ...
  detailAdr: "ADR-065",
  detailPackage: "src/infrastructure/mongodb/contracts/ingest-isolation/",
  warehouseMirrorAdr: "ADR-057",
  warehouseMirrorPackage: "src/events/contracts/event-warehouse/",
...
export const PLACEMENT = {
  architectureContract: "src/infrastructure/mongodb/contracts/analytics/",
  ...
  mgmtDashboardPackage: "src/modules/admin/ui/analytics/",
  ...
  failureIsolationPackage: "src/infrastructure/mongodb/contracts/ingest-isolation/",
  boundariesPackage: "src/infrastructure/mongodb/contracts/boundaries/",
  runtimeAdr: "ADR-110",
} as const;
