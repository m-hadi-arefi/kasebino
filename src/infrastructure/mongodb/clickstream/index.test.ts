...
describe("ADR-060 User Behavior and Clickstream Tracking", () => {
  it("locks beacon clickstream to mos_behavior via trackClickstream", () => {
    ...
    expect(CLICKSTREAM_PLACEMENT.package).toBe("src/infrastructure/mongodb/clickstream/");
    ...
    expect(() =>
      assertClickstreamImplementedHere("src/infrastructure/mongodb/clickstream/"),
    ).not.toThrow();
