 ...
 * Claims carry tenant + roles for ADR-034 RBAC (`src/infrastructure/security/rbac`).
...
import { AUTH_SECRET_ENV } from "../../../../shared/contracts/env-secrets/index.js";
...
export const NEXTAUTH_JWT_MODULE = {
  contractPath: "src/infrastructure/auth/contracts/nextauth-jwt",
