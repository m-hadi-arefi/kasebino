...
import { UNIQUE_BUSINESS_KEYS } from "../indexing/index.js";
...
describe("ADR-047 Data Integrity Soft Delete and Audit Fields", () => {
  ...
  it("defines AuditPort insert-only with Mongo mos_audit implemented in ADR-058", () => {
    ...
    expect(AUDIT_TRAIL_PORT.implementationPackage).toBe("src/infrastructure/security/contracts/audit-logging/");
  ...
  it("aggregates the data-integrity strategy and points purge to ADR-064", () => {
    ...
    expect(SOFT_DELETE.purgePolicyPackage).toBe("src/infrastructure/database/contracts/retention/");
