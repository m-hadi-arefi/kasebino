...
import { AUDIT_LOGGING_DECISION } from "../../../security/contracts/audit-logging/index.js";
import { CLICKSTREAM_DECISION } from "../../../mongodb/clickstream/index.js";
import { HARD_DELETE_POLICY } from "../data-integrity/index.js";
import { EVENT_WAREHOUSE_DECISION } from "../../../../events/contracts/event-warehouse/index.js";
import {
  MONGO_COLLECTIONS,
  MONGO_SESSION_COLLECTION,
} from "../../../mongodb/contracts/analytics/index.js";
import { SESSION_ANALYTICS_DECISION } from "../../../../modules/analytics/domain/session/index.js";
import {
  DATA_RETENTION,
...
describe("ADR-064 Data Retention Strategy", () => {
  it("locks decision matrix + placement", () => {
    ...
    expect(DATA_RETENTION_PLACEMENT.package).toBe("src/infrastructure/database/contracts/retention/");
    expect(DATA_RETENTION.requirements).toEqual(DATA_RETENTION_REQUIREMENTS);
    expect(() =>
      assertRetentionImplementedHere("src/infrastructure/database/contracts/retention/"),
    ).not.toThrow();
