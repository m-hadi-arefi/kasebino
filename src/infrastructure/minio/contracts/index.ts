...
export const PLACEMENT = {
  package: "src/infrastructure/minio/contracts/",
  port: "src/infrastructure/minio/contracts/port.ts",
  inMemoryAdapter: "src/infrastructure/minio/contracts/in-memory-adapter.ts",
