 ...
 * `src/infrastructure/emqx/realtime-client` (ADR-039).
 *
...
import { TENANT_KEY_PROPAGATION } from "../../../shared/contracts/multi-tenant-isolation/index.js";
...
export const PLACEMENT = {
  package: "src/infrastructure/emqx/contracts/",
  port: "src/infrastructure/emqx/contracts/port.ts",
  inMemoryBroker: "src/infrastructure/emqx/contracts/in-memory-broker.ts",
...
export const EMQX_REQUIREMENTS = {
  ...
  /** Browser subscribe + poll fallback → `src/infrastructure/emqx/realtime-client` (ADR-039). */
  clientStrategyDeferredTo039: false,
  clientStrategyPackage: "src/infrastructure/emqx/realtime-client",
  clientStrategyAdr: "ADR-039",
} as const;
...
export const CLIENT_CREDENTIALS = {
  ...
  /** HTTP Route Handler + browser MQTT client → `src/infrastructure/emqx/realtime-client` (ADR-039). */
  httpRouteImplementedIn: "src/infrastructure/emqx/realtime-client",
