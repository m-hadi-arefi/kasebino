...
} from "../../../database/contracts/data-integrity/index.js";
import {
  MONGO_COLLECTIONS,
  TENANCY_AND_AUTHZ,
  UNICODE_PAYLOAD_SAFETY,
} from "../../../mongodb/contracts/analytics/index.js";
import { ISOLATED_INGEST_PATHS } from "../../../mongodb/contracts/ingest-isolation/index.js";
...
export const AUDIT_LOGGING_DECISION = {
  ...
  architecturePackage: "src/infrastructure/security/contracts/audit-logging/",
...
export const AUDIT_LOGGING_PLACEMENT = {
  package: "src/infrastructure/security/contracts/audit-logging/",
  collection: MONGO_COLLECTIONS.audit,
  detailAdr: "ADR-058",
