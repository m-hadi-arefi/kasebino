...
import { API_ERROR_MESSAGES_FA } from "../../../shared/contracts/api-standards/index.js";
...
describe("ADR-055 Rate Limiting Strategy", () => {
  ...
  it("builds RateLimitTriggered security event payloads", () => {
    ...
    expect(RATE_LIMIT_EVENT.auditPackage).toBe("src/infrastructure/security/contracts/audit-logging/");
