...
import { AUDIT_AUTHZ, AUDIT_LOGGING_UX_FA } from "../audit-logging/index.js";
import {
  MGMT_API_PATHS,
  MGMT_CACHE,
  MGMT_TITLES_FA,
  MGMT_UX_FA,
} from "../mgmt-dashboard-analytics/index.js";
...
export const ADMIN_DASHBOARD_DECISION = {
  ...
  adminDomainPackage: "src/admin-domain/",
  mgmtAnalyticsPackage: "src/mgmt-dashboard-analytics/",
