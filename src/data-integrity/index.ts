...
} from "../indexing-standards/index.js";
...
export const SOFT_DELETE = {
  ...
  /** Hard-purge eligibility / grace → `src/data-retention` (ADR-064). */
  purgePolicyAdr: "ADR-064",
  purgePolicyPackage: "src/data-retention/",
} as const;
...
export const HARD_DELETE_POLICY = {
  ...
  retentionPurgePolicyPackage: "src/data-retention/",
  codingRule: "docs/rules/coding-rules.md",
} as const;

/**
 * Audit trail port — Mongo mos_audit insert-only via `src/audit-logging/` (ADR-058).
...
export const AUDIT_TRAIL_PORT = {
  ...
  implementationPackage: "src/audit-logging/",
