 ...
 * Sessions → `src/session-analytics/` (ADR-061).
 *
...
export const CLICKSTREAM_DECISION = {
  ...
  architecturePackage: "src/clickstream/",
  ...
  sessionsImplementedIn: "src/session-analytics/",
  sessionsAdr: "ADR-061",
...
export const CLICKSTREAM_API = {
  ...
  /** Session start/heartbeat/end — ADR-061 (`src/session-analytics`); HTTP wire ARD-027. */
