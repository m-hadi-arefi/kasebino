...
import { URL_PATHS } from "../../../../shared/contracts/app-router-structure/index.js";
import { MERCHANT_AUTH_DECISION } from "../../../identity/domain/merchant-auth/index.js";
...
/**
 * Offline policy — online-first P0; sale queue + SW via ADR-024 (`src/modules/pos/offline`).
 */
export const STAFF_PWA_OFFLINE = {
  ...
  offlinePackage: "src/modules/pos/offline" as const,
  offlineAdr: "ADR-024" as const,
  bannerFa: "اتصال قطع است — فروش در صف آفلاین ذخیره شد.",
  noteFa:
    "مسیر آنلاین صندوق اولویت P0 است؛ صف فروش آفلاین و همگام‌سازی در ADR-024 (`src/modules/pos/offline`) فعال است.",
