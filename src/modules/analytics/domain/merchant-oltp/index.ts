 ...
 * → ARD-016. Merchant dashboard UI stubs → ADR-088 (`src/modules/merchant/ui/dashboard`).
 *
...
} from "../../../../infrastructure/redis/cache-keys/index.js";
...
export const MERCHANT_OLTP_PLACEMENT = {
  package: "src/modules/analytics/domain/merchant-oltp/",
  modulesPackage: "src/modules/analytics/",
  detailAdr: "ADR-063",
  relatedArd: "ARD-016",
} as const;
