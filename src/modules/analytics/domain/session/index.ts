...
import { MONGO_ANALYTICS_PLANE } from "../../../../infrastructure/mongodb/contracts/boundaries/index.js";
import {
  MONGO_COLLECTIONS,
  TENANCY_AND_AUTHZ,
...
export const SESSION_ANALYTICS_DECISION = {
  ...
  architecturePackage: "src/modules/analytics/domain/session/",
...
export const SESSION_PLACEMENT = {
  package: "src/modules/analytics/domain/session/",
