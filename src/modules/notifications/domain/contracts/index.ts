...
import { EVENT_UX_FA } from "../../../../events/contracts/event-driven/index.js";
import { OTP_LOG_HYGIENE } from "../../../../infrastructure/security/contracts/architecture/index.js";
...
export const NOTIFICATIONS_DECISION = {
  ...
  architecturePackage: "src/modules/notifications/domain/contracts/",
...
export const NOTIFICATIONS_PLACEMENT = {
  package: "src/modules/notifications/domain/contracts/",
