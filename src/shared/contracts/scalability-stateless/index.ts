 ...
 *
 * Session: `src/infrastructure/auth/contracts/nextauth-jwt` (ADR-033). Redis: `src/infrastructure/redis/contracts` (ADR-051).
 * Deploy unit: `src/shared/contracts/modular-monolith` (ADR-004). Image/process: `src/shared/contracts/containerization` (ADR-067).
 */
...
import { REDIS_REQUIREMENTS } from "../../../infrastructure/redis/contracts/index.js";
...
export const SESSION_BINDING = {
  ...
  implementation: "src/infrastructure/auth/contracts/nextauth-jwt",
...
export const SCALABILITY_MODULE = {
  contractPath: "src/shared/contracts/scalability-stateless",
  adr: "ADR-071",
} as const;
