...
/**
 * Server-state ownership — TanStack Query via `src/data-fetching` (ADR-026).
...
export const SERVER_STATE_OWNERSHIP = {
  ...
  /** Wiring landed in `src/data-fetching` (ADR-026). */
...
export const STATE_MANAGEMENT_PATHS = {
  strategyRoot: "src/state-management",
