...
| Script | Purpose |
|--------|---------|
| `.agents/skills/design-system/scripts/generate-tokens.cjs` | Generate CSS from JSON token config |
| `.agents/skills/design-system/scripts/validate-tokens.cjs` | Check for hardcoded values in code |
| `.agents/skills/design-system/scripts/search-slides.py` | BM25 search + contextual recommendations |
| `.agents/skills/design-system/scripts/slide-token-validator.py` | Validate slide HTML for token compliance |
| `.agents/skills/design-system/scripts/fetch-background.py` | Fetch images from Pexels/Unsplash |
